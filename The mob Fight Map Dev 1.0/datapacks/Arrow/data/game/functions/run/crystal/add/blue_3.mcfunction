...
data modify entity @e[type=marker,limit=1,sort=nearest,tag=blue_crystal] Pos set from storage run map.crystalPos.blue[2]
...
scoreboard players set dirtTime red 35
scoreboard players set crystal_count blue 3