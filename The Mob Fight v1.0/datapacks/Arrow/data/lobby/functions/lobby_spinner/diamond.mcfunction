...
summon text_display 5.50 58.76 101.5 {Tags:["lobby_spinner_word"],text:'{"translate":"map.credit","color": "gold"}',billboard:"vertical",brightness:{block:15,sky:15},background:0,text_opacity:175}
summon text_display 5.50 58.53 101.5 {Tags:["lobby_spinner_word"],text:'{"nbt":"map.credit[0]","color": "green","storage": "run"}',billboard:"vertical",brightness:{block:15,sky:15},background:0,text_opacity:175}
summon text_display 5.50 58.30 101.5 {Tags:["lobby_spinner_word"],text:'{"nbt":"map.credit[1]","color": "green","storage": "run"}',billboard:"vertical",brightness:{block:15,sky:15},background:0,text_opacity:175}
summon text_display 5.50 58.03 101.5 {Tags:["lobby_spinner_word"],text:'{"translate":"map.arr.fixed","color": "aqua"}',billboard:"vertical",brightness:{block:15,sky:15},background:0,text_opacity:175}
...
summon text_display 0.5 44.2 -101.5 {Tags:["lobby_spinner_word"],text:'[{"text":"","color": "aqua"},"✵ ",{"translate":"info.shop_preview"}," ✵"]',billboard:"vertical",brightness:{block:15,sky:15},background:0,text_opacity:175}
