...
summon armor_stand 10 57.5 98 {Invisible:1b,NoGravity:1b,Invulnerable:1b,CustomNameVisible:1b,CustomName:'{"translate":"★ Lobby ★","color": "gold"}',ArmorItems:[{},{},{},{id:"gold_block",Count:1b}],Tags:["lobby_spinner"],DisabledSlots:16191}
summon armor_stand 10 58.2 98 {Invisible:1b,NoGravity:1b,Invulnerable:1b,Marker:1b,DisabledSlots:16191,Tags:["lobby_spinner_word"],CustomNameVisible:1b,CustomName:'{"translate":"spinner.join_game","color": "yellow"}'}
...
fill 10 42 -71 -10 42 -71 light_blue_concrete
