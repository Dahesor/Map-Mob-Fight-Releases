...
execute if entity @s[tag=ice_magic] as @a[gamemode=adventure,team=!,dx=2,dy=2,dz=2] run function game:run/mob_tick/ice_wizard/hurt
...
execute if entity @s[tag=dark_magic] as @a[gamemode=adventure,team=!,distance=..2.2] run function game:run/mob_tick/dark_wizard/hurt
...
execute if entity @s[tag=poison_magic] as @a[gamemode=adventure,team=!,distance=..2.2] run function game:run/mob_tick/poison_wizard/hurt
...
execute if entity @s[tag=wind_magic] as @a[gamemode=adventure,team=!,distance=..2.2] run function game:run/mob_tick/wind_wizard/hurt
...
execute if entity @s[tag=water_magic] as @a[gamemode=adventure,team=!,distance=..2.2] run function game:run/mob_tick/water_wizard/hurt
...
execute if entity @s[tag=wounding_magic] as @a[gamemode=adventure,team=!,distance=..2.2] run function game:run/mob_tick/wounding_wizard/hurt
...
execute if entity @s[tag=twitching_magic] as @a[gamemode=adventure,team=!,distance=..2.2] run function game:run/mob_tick/twitching_wizard/hurt
...
execute if entity @s[tag=tp_magic] as @a[gamemode=adventure,team=!,distance=..2.4,limit=1] run function game:run/mob_tick/tp_wizard/hurt
