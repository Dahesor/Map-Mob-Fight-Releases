...
execute if score ore_ticker red >= oreCoolDown red run function game:run/resources/store_red
execute if score ore_ticker blue >= oreCoolDown blue run function game:run/resources/store_blue
