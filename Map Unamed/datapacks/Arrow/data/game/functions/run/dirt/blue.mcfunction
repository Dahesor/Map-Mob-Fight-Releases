...
execute store result score #randomd calculator run data get entity @e[type=marker,tag=random_dirt,limit=1] UUID[0]
scoreboard players operation #randomd calculator %= #10 calculator
...
execute at @e[type=marker,tag=random_dirt,limit=1] run particle poof ~ ~1 ~ 0.5 0.5 0.5 0.05 9 normal @a
...
scoreboard players set dirtCD blue -5
