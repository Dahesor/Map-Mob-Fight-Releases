...
execute store result score @s calculator run clear @s #ui:buttons{ui:{id:"villager"}}
execute if score @s calculator matches 1.. run function ui:actions/settings/villager_warning
