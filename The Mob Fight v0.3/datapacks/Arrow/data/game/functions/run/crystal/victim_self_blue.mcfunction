...
execute if score beemLevel blue matches 2 run data merge storage run {macro_crystal:{damage:7.0f}}
execute if score beemLevel blue matches 3..4 run data merge storage run {macro_crystal:{damage:9.0f}}
execute if score beemLevel blue matches 4.. at @s as @e[type=#game:mobs,distance=..2] run damage @s 2 mob_attack
execute if score beemLevel blue matches 5 run data merge storage run {macro_crystal:{damage:8.0f}}
...
execute if score beemLevel blue matches 5 run damage @s 3 generic_kill
...
execute if score beemLevel blue matches 4.. at @s run function game:run/crystal/debuff
