...
kill @e[type=armor_stand,limit=1,tag=altar_blue_shop]
execute at @e[type=marker,limit=1,tag=altar_blue] run summon armor_stand ~ ~ ~ {Marker:1b,Invisible:0b,Tags:["altar_blue_shop"],Small:1b}
execute if data storage run map.altar.blue{facing:"north"} run data merge entity @e[type=armor_stand,tag=altar_blue_shop,limit=1] {Rotation:[-180.0f,0.0f]}
execute if data storage run map.altar.blue{facing:"south"} run data merge entity @e[type=armor_stand,tag=altar_blue_shop,limit=1] {Rotation:[0.0f,0.0f]}
execute if data storage run map.altar.blue{facing:"west"} run data merge entity @e[type=armor_stand,tag=altar_blue_shop,limit=1] {Rotation:[90.0f,0.0f]}
execute if data storage run map.altar.blue{facing:"east"} run data merge entity @e[type=armor_stand,tag=altar_blue_shop,limit=1] {Rotation:[-90.0f,0.0f]}
execute if data storage run map.altar.blue{extend:1b} as @e[type=armor_stand,tag=altar_blue_shop,limit=1] at @s run tp @s ^ ^ ^1
execute if data storage run map.altar.blue{drop:1b} as @e[type=armor_stand,tag=altar_blue_shop,limit=1] at @s run tp @s ^ ^-1 ^
schedule function game:shop/netherite/animation/spread_blue/wait 10t