...
execute if score @s crossbow matches 1 run data merge storage run {Pay:{gold:7b}}
execute if score @s crossbow matches 2 run data merge storage run {Pay:{gold:12b,lapis:7b}}
