...
execute if score #random calculator matches 7 run data modify storage run PosRecord insert 800 from storage run holder
execute if score #random calculator matches 8 run data modify storage run PosRecord append from storage run holder
