...
execute if entity @s[team=blue] if score science_techno blue matches 3 run scoreboard players add techNetherite blue 1
execute if entity @s[team=red] if score science_techno red matches 3 run scoreboard players add techNetherite red 1
