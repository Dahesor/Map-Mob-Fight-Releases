...
execute if entity @a[predicate=!map:on_wait] if score #startPend calculator matches ..7 run execute as @a at @s run playsound arrow:event.game_waiting master @s ~ ~ ~ 1 1.1 1
