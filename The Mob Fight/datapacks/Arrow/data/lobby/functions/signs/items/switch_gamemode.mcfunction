...
execute if score GameMode Data matches 1 run data modify block 4 57 95 front_text.messages[1] set value '{"translate": "gamemode.1","color": "dark_purple"}'
...
execute if score GameMode Data matches 3 run data modify block 4 57 95 front_text.messages[1] set value '{"translate": "gamemode.3","color": "light_purple"}'
execute if score GameMode Data matches 4 run data modify block 4 57 95 front_text.messages[1] set value '{"translate": "gamemode.4","color": "dark_red"}'