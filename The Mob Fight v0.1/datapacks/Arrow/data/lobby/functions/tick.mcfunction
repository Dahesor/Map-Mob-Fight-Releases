...
execute unless score game Data matches 1.. as @a at @s if block ~ ~-0.8 ~ #lobby:join_red run function lobby:team_join_red
execute unless score game Data matches 1.. as @a at @s if block ~ ~-0.8 ~ #lobby:join_blue run function lobby:team_join_blue
execute unless score game Data matches 1.. as @a at @s if block ~ ~-0.8 ~ #lobby:join_random run function lobby:team_join_random
...
execute if block 4 58 100 minecraft:birch_button[powered=true] if score lobby_state Data matches 1 run function lobby:start_game/pressed
