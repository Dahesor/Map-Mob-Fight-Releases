...
tellraw @s "======================="
execute if score GameMode Data matches 0 run tellraw @s [{"translate":"chat.head.game"}," ",{"translate":"gamemode.0","color":"green"}," : "]
execute if score GameMode Data matches 1 run tellraw @s [{"translate":"chat.head.game"}," ",{"translate":"gamemode.1","color":"gold"}," : "]
execute if score GameMode Data matches 2 run tellraw @s [{"translate":"chat.head.game"}," ",{"translate":"gamemode.2","color":"aqua"}," : "]
execute if score GameMode Data matches 3 run tellraw @s [{"translate":"chat.head.game"}," ",{"translate":"gamemode.3","color":"light_purple"}," : "]
execute if score GameMode Data matches 4 run tellraw @s [{"translate":"chat.head.game"}," ",{"translate":"gamemode.4","color":"red"}," : "]
