...
execute as @a[gamemode=!spectator] at @s run function lobby:player/switch_team
...
execute unless score AdminSettingsOn Options matches 1.. if block 4 58 100 #minecraft:buttons[powered=true] if score lobby_state Data matches 1 run function lobby:start_game/pressed
