...
execute at @e[type=marker,limit=1,sort=nearest,tag=pigman_cage_marker] run data modify block ~ ~ ~ posX set from storage run map.pigMan.blue.posX
execute at @e[type=marker,limit=1,sort=nearest,tag=pigman_cage_marker] run data modify block ~ ~ ~ posY set from storage run map.pigMan.blue.posY
execute at @e[type=marker,limit=1,sort=nearest,tag=pigman_cage_marker] run data modify block ~ ~ ~ posZ set from storage run map.pigMan.blue.posZ
