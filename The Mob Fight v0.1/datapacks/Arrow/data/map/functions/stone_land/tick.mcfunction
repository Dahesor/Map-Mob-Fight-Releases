...
execute if score #map$stoneland$red_water calculator matches 1 run fill 40 48 5 41 49 5 bedrock
execute if score #map$stoneland$blue_water calculator matches 1 run fill -40 48 -6 -41 49 -6 bedrock
