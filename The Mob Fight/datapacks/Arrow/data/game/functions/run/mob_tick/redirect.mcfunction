...
execute if entity @s[tag=crystal_marker,type=potion] at @s run particle dust 0.165 0.18 1 1 ~ ~ ~ 0 0 0 0 0 force @a
execute if entity @s[tag=crystal_marker,type=marker] at @s run function game:player/warped_stick/crystal_marker/self_tick
...
execute if entity @s[tag=mob.enchanter] at @s positioned ~ ~-0.3 ~ run function game:run/mob_tick/enchanter/ticker