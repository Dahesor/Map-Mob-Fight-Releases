...
execute at @e[tag=red_netherite,tag=notInitialized,limit=1,sort=nearest,type=marker] run summon item ~ ~ ~ {Item:{id:"netherite_ingot",Count:1b,tag:{isGameRes:2b,CanDestroy:["#game:breakable"],HideFlags:8}},Tags:["red_netherite"],Glowing:1b}
