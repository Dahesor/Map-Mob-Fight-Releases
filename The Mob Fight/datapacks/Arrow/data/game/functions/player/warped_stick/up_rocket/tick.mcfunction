...
execute if entity @s[nbt={OnGround:1b},tag=!using_UpRocket_1,tag=!using_UpRocket_2,tag=!using_UpRocket_3] at @s run function game:player/warped_stick/up_rocket/over