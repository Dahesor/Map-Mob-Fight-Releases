...
execute if entity @s[team=blue] if score society_populate blue matches 3 run scoreboard players add techNetherite blue 1
execute if entity @s[team=red] if score society_populate red matches 3 run scoreboard players add techNetherite red 1
