...
execute if score GameMode Data matches 1 run data remove storage run Pay
execute if score GameMode Data matches 1 run data merge storage run {Pay:{dirt:10b,netherite:1b,lapis:4b}}
execute if score GameMode Data matches 1 run data remove storage run PayName
execute if score GameMode Data matches 1 run data merge storage run {PayName:"potion_regen_uhc"}
