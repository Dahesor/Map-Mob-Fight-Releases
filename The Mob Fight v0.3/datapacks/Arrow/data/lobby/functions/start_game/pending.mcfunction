...
execute if entity @a[predicate=!map:on_wait,tag=!spectator] if score #startPend calculator matches ..7 run execute as @a at @s run playsound arrow:event.game_waiting master @s ~ ~ ~ 0.65 1.0 0.65
