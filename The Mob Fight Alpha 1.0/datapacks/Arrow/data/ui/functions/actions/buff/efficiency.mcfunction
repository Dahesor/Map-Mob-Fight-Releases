...
execute if score efficiency calculator matches 0 run data merge storage run {Pay:{dirt:7b,lapis:2b,iron:2b}}
execute if score efficiency calculator matches 1 run data merge storage run {Pay:{dirt:12b,lapis:4b,iron:4b}}
execute if score efficiency calculator matches 2 run data merge storage run {Pay:{dirt:21b,iron:7b,lapis:6b}}

execute if score efficiency calculator matches 0..2 run function game:shop/pay/anchor
execute if score efficiency calculator matches 0..2 if score @s[team=red] Payment matches 0 run scoreboard players add efficiency red 1
execute if score efficiency calculator matches 0..2 if score @s[team=blue] Payment matches 0 run scoreboard players add efficiency blue 1
