...
execute if entity @s[tag=ice_magic] at @s as @e[type=#game:magic_target,distance=..2.2] run function game:run/mob_tick/ice_wizard/hurt
...
execute if entity @s[tag=dark_magic] at @s as @e[type=#game:magic_target,distance=..2.2] run function game:run/mob_tick/dark_wizard/hurt
...
execute if entity @s[tag=poison_magic] at @s as @e[type=#game:magic_target,distance=..2.2] run function game:run/mob_tick/poison_wizard/hurt
...
execute if entity @s[tag=wind_magic] at @s as @e[type=#game:magic_target,distance=..2.2] run function game:run/mob_tick/wind_wizard/hurt
...
execute if entity @s[tag=water_magic] at @s as @e[type=#game:magic_target,distance=..2.2] run function game:run/mob_tick/water_wizard/hurt
execute if entity @s[tag=wounding_magic] at @s as @a[gamemode=adventure,team=!,distance=..2.2] run function game:run/mob_tick/wounding_wizard/hurt
execute if entity @s[tag=wounding_magic] at @s as @e[type=#game:magic_target,distance=..2.2] run function game:run/mob_tick/wounding_wizard/hurt
execute if entity @s[tag=twitching_magic] at @s as @a[gamemode=adventure,team=!,distance=..2.2] run function game:run/mob_tick/twitching_wizard/hurt
execute if entity @s[tag=twitching_magic] at @s as @e[type=#game:magic_target,distance=..2.2] run function game:run/mob_tick/twitching_wizard/hurt
...
execute if entity @s[tag=wounding_magic] at @s run playsound minecraft:entity.player.burp master @a ~ ~ ~ 1 0.7
execute if entity @s[tag=twitching_magic] at @s run playsound minecraft:entity.splash_potion.break master @a ~ ~ ~ 1 1.04
kill