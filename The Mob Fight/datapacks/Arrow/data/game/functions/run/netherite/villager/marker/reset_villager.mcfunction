...
execute as @e[limit=1,type=villager,tag=new_villager] run function gu:generate
...
data modify entity @s data.suuid set from storage gu:main out
execute if score GameMode Data matches 3 run data merge entity @e[limit=1,type=villager,tag=new_villager] {ArmorItems:[{},{},{id:"diamond_chestplate",Count:1b,tag:{Enchantments:[{id:"blast_protection",lvl:10}]}},{}]}
tag @e[limit=1,type=villager,tag=new_villager] remove new_villager
