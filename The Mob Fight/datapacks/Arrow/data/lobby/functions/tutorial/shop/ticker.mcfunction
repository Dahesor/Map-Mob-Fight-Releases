...
execute if score #time calculator matches 50 run summon text_display -10 46 -119 {text:'{"text":"\\uf000","font": "ttu"}',billboard:"fixed",brightness:{block:15,sky:15},transformation:{scale:[6f,6f,6f],right_rotation:[0f,0f,0f,1f],left_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f]},Tags:["tut4"],background:1,alignment:"center"}
