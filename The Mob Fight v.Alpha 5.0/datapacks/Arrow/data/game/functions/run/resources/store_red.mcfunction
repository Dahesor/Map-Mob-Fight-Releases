...
execute store result score #random calculator run data get entity @e[type=marker,limit=1,sort=nearest,nbt={data:{from:"red",initialized:0b}},tag=ore_marker] UUID[2]
