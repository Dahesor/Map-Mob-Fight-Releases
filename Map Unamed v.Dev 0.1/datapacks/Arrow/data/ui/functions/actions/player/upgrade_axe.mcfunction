execute if score @s axe matches 1 run data merge storage run {Pay:[{"type":"dirt",Count:14b}]}
execute if score @s axe matches 2 run data merge storage run {Pay:[{"type":"iron",Count:11b}]}
execute if score @s axe matches 3 run data merge storage run {Pay:[{"type":"diamond",Count:5b}]}
execute if score @s axe matches 4 run data merge storage run {Pay:[{"type":"diamond",Count:6b},{"type":"quartz",Count:18b}]}
