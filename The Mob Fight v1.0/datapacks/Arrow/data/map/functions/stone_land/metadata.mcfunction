...
data modify storage run map.credit set value ["Dahesor","Bovain"]
...
data modify storage run map.villager set value {red:{Pos:[[43.5d,72.0d,-22.5d],[27.50d,66.13d,-0.5d],[15.5d,43.0d,-1.5d]]},blue:{Pos:[[-42.5d,72.0d,22.5d],[-26.50d,66.13d,0.5d],[-14.5d,43.0d,1.5d]]}}
