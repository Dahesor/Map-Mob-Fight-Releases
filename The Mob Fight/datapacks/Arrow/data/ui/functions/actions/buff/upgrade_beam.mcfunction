...
execute if score beemLevel calculator matches 4 run data merge storage run {Pay:{dirt:48b,diamond:12b,netherite:2b}}
...
execute if score @s[team=red] Payment matches 0 run tellraw @a[team=!blue] ["",{"translate":"[商店] ","color": "aqua"},{"selector":"@s","color": "yellow"}," ",{"translate":"升级了"},"[",{"translate":"水晶防御激光","color": "light_purple"},"]"]
execute if score @s[team=blue] Payment matches 0 run tellraw @a[team=!red] ["",{"translate":"[商店] ","color": "aqua"},{"selector":"@s","color": "yellow"}," ",{"translate":"升级了"},"[",{"translate":"水晶防御激光","color": "light_purple"},"]"]
execute if score @s[team=red] Payment matches 0 as @a[team=!blue] at @s run playsound entity.experience_orb.pickup player @s ~ ~ ~
execute if score @s[team=blue] Payment matches 0 as @a[team=!red] at @s run playsound entity.experience_orb.pickup player @s ~ ~ ~
