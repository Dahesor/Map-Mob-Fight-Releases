...
loot replace entity @s enderchest.5 loot ui:player/flare

loot replace entity @s enderchest.7 loot ui:player/random/unknown
loot replace entity @s enderchest.8 loot ui:player/random/unknown
...
loot replace entity @s enderchest.11 loot ui:player/repair_tool

loot replace entity @s enderchest.13 loot ui:player/potions/regen_master
loot replace entity @s enderchest.14 loot ui:player/potions/strength
loot replace entity @s enderchest.15 loot ui:player/potions/speed
loot replace entity @s enderchest.16 loot ui:player/potions/fire_resistence
...
execute if score society_populate calculator matches 1.. run item replace entity @s enderchest.23 with arrow{ui:{id:"arrow"},CustomModelData:7,display:{Name:'[{"translate":"item.arrow.normal_arrow","color": "white","italic": false},{"text": " × 16"}]',Lore:['""','{"translate":"price"}','{"translate":"dirt","with":["§a8"]}','{"translate":"点击选择","color": "yellow","italic": false}']}}
execute if score game Data matches 0 run item replace entity @s enderchest.23 with arrow{ui:{id:"arrow"},CustomModelData:7,display:{Name:'[{"translate":"item.arrow.normal_arrow","color": "white","italic": false},{"text": " × 16"}]',Lore:['""','{"translate":"price"}','{"translate":"dirt","with":["§a8"]}','{"translate":"info.shop_preview","color": "gray","italic": false}']}}
...
execute if score society_populate calculator matches 1.. if score science_techno calculator matches 1.. if score destroyMode Data matches 1 run item replace entity @s enderchest.24 with golden_shovel{ui:{id:"gold_shovel"},CustomModelData:2,HideFlags:2,display:{Name:'{"translate":"item.dirt_cleaner","color": "blue","italic": false}',Lore:['""','{"translate":"lore.dirt_cleaner.1","color":"gray","italic":false}','{"translate":"lore.dirt_cleaner.2","color":"gray","italic":false}','""','{"translate":"price"}','{"translate":"copper","with":["§a8"]}','{"translate":"diamond","with":["§a4"]}','{"translate":"点击选择","color": "yellow","italic": false}']},Damage:31}
...
execute if data storage run ShopRandom[0] run function ui:pages/player/parse