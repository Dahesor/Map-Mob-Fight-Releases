...
execute at @e[type=armor_stand,tag=tutorial_center,limit=1] run particle dust 0.153 0.914 0.192 1 ~ ~ ~ 1.2 1.2 1.2 10 10 normal

execute as @a[gamemode=!creative] run function lobby:player/tp/void_check

kill @e[tag=tutorial.tutorial,type=block_display]