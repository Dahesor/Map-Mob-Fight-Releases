...
loot replace entity @s enderchest.7 loot ui:technology/preview/science
loot replace entity @s enderchest.16 loot ui:technology/preview/magic
loot replace entity @s enderchest.25 loot ui:technology/preview/populate