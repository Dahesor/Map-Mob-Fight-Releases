...
execute if score @s Payment matches 0 if entity @s[team=red] run effect give @e[team=blue] glowing 50 0 true
...
execute if score @s Payment matches 0 if entity @s[team=blue] run effect give @e[team=red] glowing 50 0 true
