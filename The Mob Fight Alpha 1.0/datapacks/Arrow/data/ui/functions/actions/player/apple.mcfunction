...
execute if score supplyBuckupLevel calculator matches 2..3 run data merge storage run {Pay:{dirt:9b,gold:5b}}
execute if score supplyBuckupLevel calculator matches 4.. run data merge storage run {Pay:{dirt:3b,gold:5b}}
