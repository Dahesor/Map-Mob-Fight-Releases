...
item replace entity @s enderchest.11 with gray_dye{ui:{id:"need_tcho"},display:{Name:'{"text":"???","color": "red","italic": false}',Lore:['""','{"translate":"need_tcho"}','{"translate":"magic","with":[" II"],"color": "gray","italic": false}','{"translate":"supply","with":[" I"],"color": "gray","italic": false}','""','{"translate":"locked"}']}}
execute if score supplyBuckupLevel calculator matches 1.. if score magicLabLevel calculator matches 2.. run item replace entity @s enderchest.11 with warped_fungus_on_a_stick{ui:{id:"instant_heal"},CustomModelData:1,display:{Name:'{"translate":"瞬间治疗符","color": "green","italic": false}',Lore:['[{"translate":"瞬间回复4点HP，","color": "gray","italic": false}]','[{"translate":"并在接下来5秒","color": "gray","italic": false}]','{"translate":"再恢复4点HP","color": "gray","italic": false}','""','{"translate":"使用冷却：45s","color": "red","italic": false}','""','{"translate":"price"}','{"translate":"dirt","with":["§a11"]}','{"translate":"gold","with":["§a5"]}','{"translate":"quartz","with":["§a2"]}','{"translate":"点击购买","color": "yellow","italic": false}']}}
...
item replace entity @s enderchest.22 with gray_dye{ui:{id:"need_tcho"},display:{Name:'{"text":"???","color": "red","italic": false}',Lore:['""','{"translate":"need_tcho"}','{"translate":"supply","with":[" II"],"color": "gray","italic": false}','{"translate":"t.f_p","with":[" I"],"color": "gray","italic": false}','""','{"translate":"locked"}']}}
execute if score supplyBuckupLevel calculator matches 2.. if score poisonFireLevel calculator matches 1.. run item replace entity @s enderchest.22 with milk_bucket{ui:{id:"milk"},display:{Name:'{"translate":"item.minecraft.milk_bucket","color": "green","italic": false}',Lore:['""','{"translate":"price"}','{"translate":"iron","with":["§a4"]}','{"translate":"lapis","with":["§a4"]}','{"translate":"点击购买","color": "yellow","italic": false}']}}
...
execute if score supplyBuckupLevel calculator matches 1.. run item replace entity @s enderchest.23 with arrow{ui:{id:"arrow"},display:{Name:'[{"translate":"item.minecraft.arrow","color": "white","italic": false},{"text": " × 16"}]',Lore:['""','{"translate":"price"}','{"translate":"dirt","with":["§a6"]}','{"translate":"点击购买","color": "yellow","italic": false}']}}
...
execute if score supplyBuckupLevel calculator matches 1.. if score metalWorkLevel calculator matches 1.. run item replace entity @s enderchest.24 with golden_shovel{ui:{id:"gold_shovel"},HideFlags:2,display:{Name:'{"translate":"item.minecraft.golden_shovel","color": "green","italic": false}',Lore:['""','{"translate":"快速挖掘泥土，可惜太脆","color": "gray","italic": false}','""','{"translate":"price"}','{"translate":"gold","with":["§a6"]}','{"translate":"iron","with":["§a4"]}','{"translate":"点击购买","color": "yellow","italic": false}']}}
