...
summon armor_stand 0.50 62.5 79.50 {Tags:["lobby_spinner_word"],CustomName:'{"text": "★ Credit & Settings ★","color": "gold","italic": false}',CustomNameVisible:1b,Marker:1b,Invisible:1b,Invulnerable:1b,NoGravity:1b,NoBasePlate:1b}
