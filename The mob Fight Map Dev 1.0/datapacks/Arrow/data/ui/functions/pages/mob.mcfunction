...
item replace entity @s enderchest.26 with hopper{UISpaceHolder:1b,display:{Name:'{"translate":"筛选","color":"red","italic":false}',Lore:['""','{"translate":"功能尚未上线","color": "gray"}','{"translate":"敬请期待","color": "red","italic": false}']}}
