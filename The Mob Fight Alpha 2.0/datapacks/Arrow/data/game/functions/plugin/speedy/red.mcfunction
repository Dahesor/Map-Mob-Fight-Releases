...
execute as @a[team=red] run attribute @s generic.attack_speed modifier add 8e5f3313-43a6-42b0-87b7-35637aed704f '"\\ue900"' 0.32 multiply_base
...
execute if score magic_occult red matches 1 run schedule function game:plugin/speedy/red_end 30s
execute if score magic_occult red matches 2 run schedule function game:plugin/speedy/red_end 40s
execute if score magic_occult red matches 3.. run schedule function game:plugin/speedy/red_end 50s