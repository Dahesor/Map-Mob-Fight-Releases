...
execute if score beemLevel blue matches 2 run data merge storage run {macro_crystal:{damage:8.0f}}
execute if score beemLevel blue matches 3..4 run data merge storage run {macro_crystal:{damage:11.0f}}
execute if score beemLevel blue matches 4.. at @s as @e[type=#game:mobs,distance=..3.5,tag=!crystal_targeted] run function game:run/crystal/area
tag @s remove crystal_targeted
execute if score beemLevel blue matches 5 run data merge storage run {macro_crystal:{damage:5.0f}}
