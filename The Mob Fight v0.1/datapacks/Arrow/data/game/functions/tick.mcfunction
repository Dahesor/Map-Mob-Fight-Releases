...
execute as @e[type=arrow,predicate=game:actived_arrow,nbt=!{custom_potion_effects:[{id:'minecraft:hero_of_the_village',amplifier:50b}]}] at @s align xz positioned ~0.5 ~0.1 ~0.5 run function game:plugin/unstack/main
