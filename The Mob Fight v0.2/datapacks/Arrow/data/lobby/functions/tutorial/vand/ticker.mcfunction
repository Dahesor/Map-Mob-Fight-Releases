...
execute if score #time calculator matches 120 run summon armor_stand 10.50 45.40 -117.50 {Marker:1b,Invisible:1b,Tags:["tut6"],CustomName:'["",{"translate":"action.drop","color": "green"}," ",{"translate":"netherite.nn"}]',CustomNameVisible:1b}
execute if score #time calculator matches 120 run summon armor_stand 10.50 45.20 -117.50 {Marker:1b,Invisible:1b,Tags:["tut6","tut6_use"],CustomName:'["",{"translate":"logic.or","bold": true}," ",{"translate":"iron","with":["32"]}]',CustomNameVisible:1b}

execute if score #time calculator matches 180 run kill @e[type=armor_stand,limit=1,tag=tut6_use]
execute if score #time calculator matches 180 run summon armor_stand 10.50 45.20 -117.50 {Marker:1b,Invisible:1b,Tags:["tut6","tut6_use"],CustomName:'["",{"translate":"logic.or","bold": true}," ",{"translate":"diamond","with":["26"]}]',CustomNameVisible:1b}
