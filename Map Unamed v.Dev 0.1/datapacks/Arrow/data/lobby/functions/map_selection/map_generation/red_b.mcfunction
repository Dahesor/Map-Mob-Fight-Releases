...
execute if data storage run map.Structures{type:"specialized"} run schedule function lobby:map_selection/map_generation/blue_a 1t
execute if data storage run map.Structures{type:"rotation"} run schedule function lobby:map_selection/map_generation/rotate_red_a 1t
