...
execute if entity @e[tag=in_flag_effect,tag=red_crystal,type=end_crystal] run tag @s[team=!red,team=!blue,predicate=map:in_blue] add in_flag_effect
execute if entity @e[tag=in_flag_effect,tag=blue_crystal,type=end_crystal] run tag @s[team=!red,team=!blue,predicate=map:in_red] add in_flag_effect
