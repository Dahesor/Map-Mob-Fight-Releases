...
scoreboard players set realisticOreDrop Options 0
...
#define score_holder realisticOreDrop If set to 0, ores will be sent directly into miners' inventory
#define score_holder disableOreConvert If set to 1, disable ore conversion page
#define score_holder THUNDER.flashMaxChance THUNER MODE: Lower number makes more lighting flashes