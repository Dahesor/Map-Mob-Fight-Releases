give @s tipped_arrow{CustomPotionColor:6579300}


give @s diamond_pickaxe{display:{Name:'{"translate":"升级盔甲","color": "green","italic": false}',Lore:['""','{"translate":"速度极快但生命值极低","color": "gray","italic": false}','{"translate":"的三只僵尸！","color": "gray","italic": false}']}}
