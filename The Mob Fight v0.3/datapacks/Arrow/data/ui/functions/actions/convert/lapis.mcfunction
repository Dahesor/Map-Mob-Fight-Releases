...
scoreboard players operation #count calculator /= #35 calculator
scoreboard players operation #energy calculator = #temp calculator
scoreboard players operation #energy calculator %= #35 calculator
...
item replace entity @s enderchest.16 with lapis_lazuli{isGameRes:2b,CanDestroy:['#game:breakable'],HideFlags:12}
