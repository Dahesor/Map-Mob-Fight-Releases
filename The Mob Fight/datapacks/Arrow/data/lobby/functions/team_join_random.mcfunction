...
execute if entity @s[gamemode=!spectator] if score game Data matches 1.. if score AdminJoinMidOn Options matches 1.. run function game:utility/join_self_random
