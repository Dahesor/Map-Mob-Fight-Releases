...
execute as @a[team=red] run attribute @s generic.armor_toughness modifier remove 8e5f3313-43a6-42b0-87b7-35637aed704f
scoreboard players set onSpeedyEffect red 0

tag @a[team=red] remove speedy_partical
tag @e[type=#game:mobs,predicate=map:in_blue] remove speedy_partical