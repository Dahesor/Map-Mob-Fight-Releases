...
execute if score #time calculator matches 130 run summon villager -19.0 45.0 -74.50 {Rotation:[180f,0f],Tags:["tut1"],NoAI:1b,Silent:1b,VillagerData:{type:"minecraft:swamp"}}
execute if score #time calculator matches 130 run summon villager -19.0 45.0 -80.50 {Rotation:[0f,0f],Tags:["tut1","tut1_2"],NoAI:1b,VillagerData:{type:"minecraft:swamp"}}
...
execute if score #time calculator matches 450 run summon text_display -19.0 47.3 -74.50 {text:'{"text":"+200","color": "gold"}',billboard:"center",brightness:{block:15,sky:15},transformation:{scale:[2f,2f,2f],right_rotation:[0f,0f,0f,1f],left_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f]},Tags:["tut1"],alignment:"center"}
...
execute if score #time calculator matches 500 run summon text_display -19.0 48.3 -74.50 {text:'{"text":"Victory","color": "gold"}',billboard:"center",brightness:{block:15,sky:15},transformation:{scale:[3f,3f,3f],right_rotation:[0f,0f,0f,1f],left_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f]},Tags:["tut1"],alignment:"center"}
