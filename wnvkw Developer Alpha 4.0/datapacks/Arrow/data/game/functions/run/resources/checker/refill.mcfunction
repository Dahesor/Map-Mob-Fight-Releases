...
execute if score destroyMode Data matches 1.. if entity @s[nbt={data:{from:"red"}},tag=markerOreLinkingSelf] as @e[type=marker,tag=!markerOreLinkingSelf,nbt={data:{from:"red"}},sort=nearest,limit=4] run tag @s add markerOreLinkingTarget
execute if score destroyMode Data matches 1.. if entity @s[nbt={data:{from:"blue"}},tag=markerOreLinkingSelf] as @e[type=marker,tag=!markerOreLinkingSelf,nbt={data:{from:"blue"}},sort=nearest,limit=4] run tag @s add markerOreLinkingTarget
execute if score destroyMode Data matches 1.. if entity @s[nbt={data:{from:"red"}},tag=markerOreLinkingSelf] at @s as @e[type=marker,tag=!markerOreLinkingSelf,nbt={data:{from:"red"}},distance=..1.4] run tag @s add markerOreLinkingTarget
execute if score destroyMode Data matches 1.. if entity @s[nbt={data:{from:"blue"}},tag=markerOreLinkingSelf] at @s as @e[type=marker,tag=!markerOreLinkingSelf,nbt={data:{from:"blue"}},distance=..1.4] run tag @s add markerOreLinkingTarget
