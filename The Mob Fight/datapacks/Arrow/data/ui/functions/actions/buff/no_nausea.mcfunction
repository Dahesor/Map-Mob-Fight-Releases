...
execute if score @s Payment matches 0 if entity @s[team=red] run tellraw @a[team=!blue] ["",{"translate":"[商店] ","color": "aqua"},{"selector":"@s"}," ",{"translate":"购买了"},"[",{"translate":"反胃退散","color": "green"},"]"]
execute if score @s Payment matches 0 if entity @s[team=blue] run tellraw @a[team=!red] ["",{"translate":"[商店] ","color": "aqua"},{"selector":"@s"}," ",{"translate":"购买了"},"[",{"translate":"反胃退散","color": "green"},"]"]
