...
scoreboard players operation beemCD red *= #2 calculator
scoreboard players operation beemCD red /= #3 calculator
scoreboard players operation beemCD blue *= #2 calculator
scoreboard players operation beemCD blue /= #3 calculator
