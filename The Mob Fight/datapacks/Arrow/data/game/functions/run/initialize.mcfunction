...
# set Crystal CD
scoreboard players operation initialBeamCD calculator = initialBeamCD Options
scoreboard players set #multiply calculator 1000
execute if score #player calculator matches 3..4 run scoreboard players set #multiply calculator 970
execute if score #player calculator matches 5..6 run scoreboard players set #multiply calculator 940
execute if score #player calculator matches 7..8 run scoreboard players set #multiply calculator 880
execute if score #player calculator matches 9..10 run scoreboard players set #multiply calculator 830
execute if score #player calculator matches 11..12 run scoreboard players set #multiply calculator 780
execute if score #player calculator matches 13..14 run scoreboard players set #multiply calculator 750
execute if score #player calculator matches 15..16 run scoreboard players set #multiply calculator 720
execute if score #player calculator matches 17..18 run scoreboard players set #multiply calculator 670
execute if score #player calculator matches 19.. run scoreboard players set #multiply calculator 650
scoreboard players operation initialBeamCD calculator *= #multiply calculator
scoreboard players operation initialBeamCD calculator /= #1000 calculator
scoreboard players operation beemCD red = initialBeamCD calculator
scoreboard players operation beemCD blue = initialBeamCD calculator
# set Crystal CD
