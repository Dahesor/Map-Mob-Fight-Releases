...
loot replace entity @s enderchest.2 loot ui:technology/metal_work
...
loot replace entity @s enderchest.4 loot ui:technology/supply_work
loot replace entity @s enderchest.5 loot ui:background
execute if score poisonFireLevel calculator matches 0 run data merge storage run {ModelData:30}
execute if score poisonFireLevel calculator matches 1 run data merge storage run {ModelData:31}
execute if score poisonFireLevel calculator matches 2 run data merge storage run {ModelData:32}
execute if score poisonFireLevel calculator matches 3 run data merge storage run {ModelData:33}
loot replace entity @s enderchest.6 loot ui:technology/poison_fire
...
execute if score alchemyLevel calculator matches 3 run data merge storage run {ModelData:73}
