...
execute if score doArrowLandPosCheck Options matches 1.. run tag @e[type=#arrows,nbt={CustomPotionEffects:[{}]},predicate=map:middle_area] add actived
execute unless score doArrowLandPosCheck Options matches 1.. run tag @e[type=#arrows,nbt={CustomPotionEffects:[{}]}] add actived
execute as @e[type=#arrows,nbt={CustomPotionEffects:[{}]},predicate=map:middle_area] run data merge entity @s {damage:0.25d}
