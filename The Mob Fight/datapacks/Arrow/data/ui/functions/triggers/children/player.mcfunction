...
execute store result score @s calculator run clear @s #ui:buttons{ui:{id:"shield"}}
execute if score @s calculator matches 1.. run function ui:actions/player/shield
...
execute store result score @s calculator run clear @s #ui:buttons{ui:{id:"mine"}}
...
execute store result score @s calculator run clear @s #ui:buttons{ui:{id:"flare"}}
execute if score @s calculator matches 1.. run function ui:actions/player/flare