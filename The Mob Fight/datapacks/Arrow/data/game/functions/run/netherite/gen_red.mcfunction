...
execute at @e[tag=red_netherite,tag=notInitialized,limit=1,sort=nearest,type=marker] run summon item_display ~ ~0.4 ~ {item:{id:"netherite_ingot",Count:1b},item_display:"ground",Glowing:1b,billboard:"center",glow_color_override:16711680,view_range:1.5f,Tags:["netherite_glow"]}
