...
execute as @e[type=#game:mobs,predicate=map:in_blue] run attribute @s generic.movement_speed modifier add 8e5f3313-43a6-42b0-87b7-35637aed704e "speedy_movement_speed" 0.12 multiply_base
...
tag @a[team=red] add speedy_partical
tag @e[type=#game:mobs,predicate=map:in_blue] add speedy_partical
