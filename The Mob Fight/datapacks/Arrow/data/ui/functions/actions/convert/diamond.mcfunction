...
scoreboard players operation #count calculator /= #41 calculator
scoreboard players operation #energy calculator = #temp calculator
scoreboard players operation #energy calculator %= #41 calculator
...
item replace entity @s enderchest.16 with diamond{isGameRes:2b,CanDestroy:['#game:breakable'],HideFlags:12}
