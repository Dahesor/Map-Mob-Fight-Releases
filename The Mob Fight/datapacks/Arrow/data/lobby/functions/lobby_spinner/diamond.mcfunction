...
execute unless score GameMode Data matches 1..4 run summon armor_stand 5.50 58.37 96.5 {Tags:["lobby_spinner_word"],CustomName:'[{"translate": "word.gamemode","color": "gold","italic": false},{"translate": "gamemode.0","color": "green"}]',CustomNameVisible:1b,Marker:1b,Invisible:1b,Invulnerable:1b,NoGravity:1b,NoBasePlate:1b}
...
execute if score GameMode Data matches 2 run summon armor_stand 5.50 58.37 96.5 {Tags:["lobby_spinner_word"],CustomName:'[{"translate": "word.gamemode","color": "gold","italic": false},{"translate": "gamemode.2","color": "aqua"}]',CustomNameVisible:1b,Marker:1b,Invisible:1b,Invulnerable:1b,NoGravity:1b,NoBasePlate:1b}
execute if score GameMode Data matches 3 run summon armor_stand 5.50 58.37 96.5 {Tags:["lobby_spinner_word"],CustomName:'[{"translate": "word.gamemode","color": "gold","italic": false},{"translate": "gamemode.3","color": "light_purple"}]',CustomNameVisible:1b,Marker:1b,Invisible:1b,Invulnerable:1b,NoGravity:1b,NoBasePlate:1b}
execute if score GameMode Data matches 4 run summon armor_stand 5.50 58.37 96.5 {Tags:["lobby_spinner_word"],CustomName:'[{"translate": "word.gamemode","color": "gold","italic": false},{"translate": "gamemode.4","color": "dark_red"}]',CustomNameVisible:1b,Marker:1b,Invisible:1b,Invulnerable:1b,NoGravity:1b,NoBasePlate:1b}
...
summon text_display 5.50 58.76 101.5 {Tags:["lobby_spinner_word"],alignment:"center",text:'{"translate":"map.credit","color": "gold"}',billboard:"vertical",brightness:{block:15,sky:15},background:0,text_opacity:175}
summon text_display 5.50 58.53 101.5 {Tags:["lobby_spinner_word"],alignment:"center",text:'{"nbt":"map.credit[0]","color": "green","storage": "run"}',billboard:"vertical",brightness:{block:15,sky:15},background:0,text_opacity:175}
summon text_display 5.50 58.30 101.5 {Tags:["lobby_spinner_word"],alignment:"center",text:'{"nbt":"map.credit[1]","color": "green","storage": "run"}',billboard:"vertical",brightness:{block:15,sky:15},background:0,text_opacity:175}
