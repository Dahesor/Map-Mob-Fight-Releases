...
summon armor_stand 0 57.9 85 {Invisible:1b,NoGravity:1b,Invulnerable:1b,Marker:1b,DisabledSlots:16191,Tags:["lobby_spinner_word"],CustomNameVisible:1b,CustomName:'{"translate":"ERROR_Wrong_NBT_Type_Found_In_Map_Path","color": "red","bold": true}'}