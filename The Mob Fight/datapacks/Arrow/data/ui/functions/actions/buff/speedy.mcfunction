...
data merge storage run {PayName:{"translate":"阿涅摩伊的祝福","color": "gray"}}
...
execute if score @s Payment matches 0 if entity @s[team=red] run tellraw @a[team=!blue] ["",{"translate":"[商店] ","color": "aqua"},{"selector":"@s"}," ",{"translate":"激活了"},"[",{"translate":"阿涅摩伊的祝福","color": "aqua"},"]"]
execute if score @s Payment matches 0 if entity @s[team=blue] run tellraw @a[team=!red] ["",{"translate":"[商店] ","color": "aqua"},{"selector":"@s"}," ",{"translate":"激活了"},"[",{"translate":"阿涅摩伊的祝福","color": "aqua"},"]"]
