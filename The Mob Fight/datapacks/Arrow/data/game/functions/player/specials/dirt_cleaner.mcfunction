...
execute if entity @s[team=red] run scoreboard players operation dirt red += #holder$ calculator
execute if entity @s[team=blue] run scoreboard players operation dirt blue += #holder$ calculator
