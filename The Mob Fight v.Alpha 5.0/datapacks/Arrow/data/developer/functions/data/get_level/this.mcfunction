...
tellraw @s ["",{"text": "- - ","color": "green"},{"translate":"science_techno","color": "aqua"},": ",{"nbt":"run.Red.Tech.science_techno","storage": "developer:run","color": "gold"}]
tellraw @s ["",{"text": "- - ","color": "green"},{"translate":"magic_occult","color": "aqua"},": ",{"nbt":"run.Red.Tech.magic_occult","storage": "developer:run","color": "gold"}]
tellraw @s ["",{"text": "- - ","color": "green"},{"translate":"society_populate","color": "aqua"},": ",{"nbt":"run.Red.Tech.society_populate","storage": "developer:run","color": "gold"}]
...
tellraw @s {"text": "- Technology:","color": "yellow"}
tellraw @s ["",{"text": "- - ","color": "green"},{"translate":"science_techno","color": "aqua"},": ",{"nbt":"run.Blue.Tech.science_techno","storage": "developer:run","color": "gold"}]
tellraw @s ["",{"text": "- - ","color": "green"},{"translate":"magic_occult","color": "aqua"},": ",{"nbt":"run.Blue.Tech.magic_occult","storage": "developer:run","color": "gold"}]
tellraw @s ["",{"text": "- - ","color": "green"},{"translate":"society_populate","color": "aqua"},": ",{"nbt":"run.Blue.Tech.society_populate","storage": "developer:run","color": "gold"}]
tellraw @s {"text": "- Enchantments:","color": "yellow"}
