...
execute if score supplyBuckupLevel calculator matches 1 run data merge storage run {Pay:{dirt:7b}}
execute if score supplyBuckupLevel calculator matches 2 run data merge storage run {Pay:{dirt:6b}}
execute if score supplyBuckupLevel calculator matches 3 run data merge storage run {Pay:{dirt:5b}}
